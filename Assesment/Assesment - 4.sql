...
-- 1. Find Nobel prize winners of the year 1970
SELECT year, subject, winner
FROM Nobel_win
WHERE year = 1970;

-- 2. Find Nobel prize winners in Chemistry between 1965 and 1975
...
-- 5. Find details of 1970 Nobel prize winners
-- Order by subject ascending, but Chemistry and Economics at the end
